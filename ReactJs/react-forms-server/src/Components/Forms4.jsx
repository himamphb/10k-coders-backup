...
class Forms4 extends Component {
  ...
  deleteUser = (user,i) => {
    var number = i + 1;
    axios.delete("http://localhost:3008/form4/" + number).then((res) => {
  ...
  updateUser = () => {
    ...
    axios({
      method: "put",
      url: "http://localhost:3008/form4/" + number,
      data: this.state.person,
    });
  ...
  async componentDidMount() {
    let response = await axios.get("http://localhost:3008/form4");
